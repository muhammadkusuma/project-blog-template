                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="isi" id="post_content" class="form-control" required><?= $post['isi'] ?? ''; ?></textarea>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <?php if ($post['gambar']) : ?>
                                        <div class="mt-2">
                                            <img id="preview" src="<?= base_url('uploads/img/') . $post['gambar']; ?>" alt="Gambar Lama" style="max-width: 200px; max-height: 200px;">
                                        </div>
                                    <?php else : ?>
                                        <div class="mt-2">
                                            <img id="preview" src="<?= base_url('uploads/img/default.jpg'); ?>" alt="Gambar Default" style="max-width: 200px; max-height: 200px;">
                                        </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepicker" data-target-input="nearest">
                                        <input type="text" name="terbit" class="form-control datetimepicker-input" data-target="#datetimepicker" value="<?= $post['created_at'] ?? ''; ?>" />
